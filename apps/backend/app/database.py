...
async def _validate_unique_constraint(collection, index: IndexModel, idx_name: str) -> bool:
...
async def _migrate_index_additive(collection, index: IndexModel, idx_name: str, conflict_name: str) -> None:
